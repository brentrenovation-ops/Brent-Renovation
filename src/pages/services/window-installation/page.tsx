...
export default function WindowInstallationPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
              ...
              <div className="relative">
                ...
                {isServicesOpen && (
                  ...
                  >
                    ...
                    <a href="/services/window-installation" className="block px-4 py-2 text-sm text-blue-600 font-medium hover:bg-blue-50 cursor-pointer">Window Installation</a>
                ...
                <div>
                  ...
                  {isServicesOpen && (
                    <div className="mt-2 ml-4 space-y-2">
                      ...
                      <a href="/services/window-installation" onClick={() => setIsMenuOpen(false)} className="block text-sm text-blue-600 font-medium hover:text-blue-700 cursor-pointer">Window Installation</a>
      ...
      {/* Hero Section */}
      <section className="relative py-20 bg-gradient-to-br from-cyan-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8">
                Expert window installation and replacement services across London. Double glazing, sash windows, modern frames with energy-efficient solutions for your property.
              </p>
              <button 
                onClick={() => document.querySelector('#quote-form')?.scrollIntoView({ behavior: 'smooth' })}
            ...
            <div 
              ...
              style={{
                backgroundImage: `url('https://readdy.ai/api/search-image?query=Professional%20window%20installation%20showing%20modern%20double%20glazed%20windows%20being%20fitted%2C%20skilled%20craftsmen%20installing%20window%20frames%2C%20contemporary%20residential%20window%20replacement%2C%20high-quality%20glazing%20work%2C%20London%20property%20renovation&width=600&height=400&seq=window-hero&orientation=landscape')`
              }}
            ></div>
          </div>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Window Services We Offer</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Complete window solutions from installation to restoration
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100">
              <div className="w-16 h-16 bg-cyan-100 rounded-full flex items-center justify-center mb-6">
                <i className="ri-window-line text-2xl text-cyan-600"></i>
              </div>
              <h3 className="text-xl font-bold text-gray-900 mb-4">Double Glazing</h3>
              <p className="text-gray-600">Energy-efficient double glazed windows with A-rated performance. Reduce heating costs and improve comfort.</p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">Sash Window Restoration</h3>
              <p className="text-gray-600">Expert restoration of traditional sash windows. Preserve period character while improving performance.</p>
            </div>

            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100">
              <div className="w-16 h-16 bg-cyan-100 rounded-full flex items-center justify-center mb-6">
                <i className="ri-door-line text-2xl text-cyan-600"></i>
              </div>
              <h3 className="text-xl font-bold text-gray-900 mb-4">UPVC Windows</h3>
              <p className="text-gray-600">Low-maintenance UPVC windows in various styles. Excellent insulation and security features.</p>
            </div>

            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100">
              <div className="w-16 h-16 bg-cyan-100 rounded-full flex items-center justify-center mb-6">
                <i className="ri-hammer-line text-2xl text-cyan-600"></i>
              </div>
              <h3 className="text-xl font-bold text-gray-900 mb-4">Timber Windows</h3>
              <p className="text-gray-600">Bespoke timber windows crafted from sustainable hardwoods. Traditional craftsmanship meets modern performance.</p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">Security Windows</h3>
              <p className="text-gray-600">Enhanced security features including multi-point locking systems and toughened glass options.</p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">Window Repairs</h3>
              <p className="text-gray-600">Professional window repairs including glass replacement, frame repairs, and hardware upgrades.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Why Choose Our Windows</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Quality windows that enhance your property's value and performance
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="w-16 h-16 bg-blue-600 rounded-full flex items-center justify-center mx-auto mb-4">
                <i className="ri-temp-cold-line text-2xl text-white"></i>
              </div>
              <h3 className="text-xl font-bold text-gray-900 mb-2">Energy Efficient</h3>
              <p className="text-gray-600">Reduce heating bills with superior thermal performance</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">Noise Reduction</h3>
              <p className="text-gray-600">Enjoy peace and quiet with excellent sound insulation</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Multi-point locking systems for maximum protection</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Durable materials requiring minimal upkeep</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Recent Window Projects</h2>
            <p className="text-lg text-gray-600">Showcasing our professional window installations</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl shadow-lg overflow-hidden">
              <div 
                ...
                style={{
                  backgroundImage: `url('https://readdy.ai/api/search-image?query=Victorian%20sash%20window%20restoration%20showing%20traditional%20timber%20sash%20windows%20with%20modern%20double%20glazing%2C%20period%20property%20window%20renovation%2C%20heritage%20window%20restoration%2C%20professional%20craftsmanship&width=400&height=400&seq=sash-project-1&orientation=squarish')`
                }}
              ></div>
              <div className="p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-2">Sash Window Restoration - Kensington</h3>
                <p className="text-gray-600">Complete restoration of Victorian sash windows with modern glazing</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden">
              <div 
                className="h-64 bg-cover bg-center"
                style={{
                  backgroundImage: `url('https://readdy.ai/api/search-image?query=Modern%20double%20glazed%20windows%20installation%20showing%20contemporary%20window%20frames%20in%20residential%20property%2C%20energy%20efficient%20glazing%2C%20professional%20window%20fitting%2C%20clean%20modern%20design&width=400&height=400&seq=double-glazing-1&orientation=squarish')`
                }}
              ></div>
              <div className="p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-2">Double Glazing Installation - Westminster</h3>
                <p className="text-gray-600">A-rated double glazed windows for improved energy efficiency</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden">
              <div 
                className="h-64 bg-cover bg-center"
                style={{
                  backgroundImage: `url('https://readdy.ai/api/search-image?query=Timber%20window%20installation%20showing%20bespoke%20hardwood%20window%20frames%2C%20traditional%20craftsmanship%2C%20sustainable%20timber%20windows%2C%20residential%20property%20renovation%2C%20quality%20joinery%20work&width=400&height=400&seq=timber-windows-1&orientation=squarish')`
                }}
              ></div>
              <div className="p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-2">Timber Windows - Camden</h3>
                <p className="text-gray-600">Bespoke hardwood windows with traditional joinery techniques</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Ready for New Windows?</h2>
      ...
      <section id="quote-form" className="py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">Tell us about your window project and we'll provide expert advice</p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  required
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-5 0 focus:border-transparent text-sm"
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400 mb-4">
                Professional window installation and replacement services across London with expert craftsmanship.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><a href="/services/window-installation" className="hover:text-white cursor-pointer">Window Installation</a></li>
              </ul>
            </div>
